        ...
        function isDefinitionExportable(node) {
            switch (node === null || node === void 0 ? void 0 : node.type) {
                case undefined: // base case
                    return false;
                case utils_1.AST_NODE_TYPES.BlockStatement: // we are an inline function, scope is not exportable
                    return false;
                case utils_1.AST_NODE_TYPES.ExportNamedDeclaration: // our definition is being exported
                    return true;
                case utils_1.AST_NODE_TYPES.Program: // our definition can be exported
                    return true;
                default:
